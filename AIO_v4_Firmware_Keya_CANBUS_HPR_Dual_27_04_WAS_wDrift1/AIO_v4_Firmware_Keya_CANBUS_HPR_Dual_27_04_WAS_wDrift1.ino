...
// Forward declarations for all handler functions from zXXXX.ino files
void errorHandler();
void GGA_Handler();
void VTG_Handler();
void HPR_Handler();
...
void motorDrive();
void SteerKeya(int16_t pwmDrive, bool intendToSteer);
void EncoderFunc();
...
void setup()
{
    ...
    //SprerialGPS->addMemoryForRead(GPSrxbuffer, serial_buffer_size);
